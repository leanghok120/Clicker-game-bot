...
autoupgrade_button = customtkinter.CTkButton(master=frame_1, text="Auto Upgrade X1", command=AutoUpgrade1.auto_upgrade_x1)
autoupgrade_button.pack(pady=10, padx=10)
autoupgrade_x10_button = customtkinter.CTkButton(master=frame_1, text="Auto Upgrade X10", command=AutoUpgrade1.auto_upgrade_x10)
autoupgrade_x10_button.pack(pady=10, padx=10)
autoupgrade_x100_button = customtkinter.CTkButton(master=frame_1, text="Auto Upgrade X100", command=AutoUpgrade1.auto_upgrade_x100)
